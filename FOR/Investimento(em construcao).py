...
for anos in range(1,trimAnos+1): #A funcao range so vai iterar ate trimAnos-1, para evitar isso, adicionamos +1
 ...
 #O CODIGO NAO ESTA COMPLETO
  #O CODIGO NAO ESTA COMPLETO #O CODIGO NAO ESTA COMPLETO #O CODIGO NAO ESTA COMPLETO #O CODIGO NAO ESTA COMPLETO
   #O CODIGO NAO ESTA COMPLETO
    #O CODIGO NAO ESTA COMPLETO
     #O CODIGO NAO ESTA COMPLETO
      #O CODIGO NAO ESTA COMPLETO
       #O CODIGO NAO ESTA COMPLETO
        #O CODIGO NAO ESTA COMPLETO #O CODIGO NAO ESTA COMPLETO
         #O CODIGO NAO ESTA COMPLETO #O CODIGO NAO ESTA COMPLETO #O CODIGO NAO ESTA COMPLETO
